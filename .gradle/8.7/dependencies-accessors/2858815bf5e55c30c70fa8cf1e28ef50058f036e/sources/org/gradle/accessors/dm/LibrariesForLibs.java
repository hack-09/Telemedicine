...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class WebrtcLibraryAccessors extends SubDependencyFactory {
        private final WebrtcAndroidLibraryAccessors laccForWebrtcAndroidLibraryAccessors = new WebrtcAndroidLibraryAccessors(owner);

        public WebrtcLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>webrtc.android</b>
         */
        public WebrtcAndroidLibraryAccessors getAndroid() {
            return laccForWebrtcAndroidLibraryAccessors;
        }

    }

    public static class WebrtcAndroidLibraryAccessors extends SubDependencyFactory {

        public WebrtcAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>framework</b> with <b>io.antmedia:webrtc-android-framework</b> coordinates and
         * with version reference <b>webrtcAndroidFramework</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getFramework() {
            return create("webrtc.android.framework");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>webrtcAndroidFramework</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWebrtcAndroidFramework() { return getVersion("webrtcAndroidFramework"); }
